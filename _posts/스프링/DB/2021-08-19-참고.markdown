...
---
**목차**
+ [유니크 제약 조건](#1-유니크-제약-조건)
+ [스프링 필드 주입 대신에 생성자 주입을 사용하자](#2-스프링-필드-주입-대신에-생성자-주입을-사용하자.)
+ [HashMap, ConcurrentHashMap](#3-HashMap-ConcurrentHashMap)
+ [실무에서는 @ManyToMany 를 사용하지 말자](#4-실무에서는-ManyToMany-를-사용하지-말자)
